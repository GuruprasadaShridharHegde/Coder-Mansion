...
class CountDown:
    def __init__(self, root):
        ...
        time_label = Label(self.window, text="Hi, Guru Set Time Now ",
        ...
        cancel_button = Button(self.window, text='Reset',
    ...
    def Get_Time(self):
        ...
        try:
            ...
            if s == 0 and m == 0 and h == 0:
                ...
                start_button = Button(self.button_frame, text='Resume',
    ...
    def start_time(self):
        ...
        while self.time_left > 0:
            ...
            if self.time_left <= 0:
                ...
                process.start()
                messagebox.showinfo(
                    'Time Over', 'Please ENTER to stop playing')
                process.terminate()
